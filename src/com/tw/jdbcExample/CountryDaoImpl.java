...
public class CountryDaoImpl implements CountryDAO {
    ...
    public Country getCountryByName(String getCountryWithName)throws SQLException {
        ...
        throw new SQLException("Country not present");
    }
    ...
    public boolean insertCountry(Country country) throws SQLException {
        ...
        if (rowsInserted > 0) {
            System.out.println("Country info added successfully!");
            countries.add(country);
            return true;
        }
        return false;
    ...
    public boolean updateCountry(Country country) throws SQLException {
        ...
        int rowsInserted = statement.executeUpdate();
        if (rowsInserted > 0) {
            System.out.println("Country info updated successfully!");
            countries.add(country);
            return true;
        }
        return false;
